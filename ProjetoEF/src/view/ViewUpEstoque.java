 ...
 * @author Jerônimo
 */
public class ViewUpEstoque extends javax.swing.JDialog {

    Estoque ProdutoOn;

    public ViewUpEstoque(java.awt.Frame parent, boolean modal, Estoque esto) {
        super(parent, modal);
        initComponents();
        ProdutoOn = esto;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Aumentar Estoque");
        ...
        jLabel3.setText("Quantos produtos deseja adicionar ao estoque?");
